...
class Figher():
    ...
    def load_images(self, sprite_sheet, animation_steps):
        #extract images from spirte sheet
        
        animation_list = []
        
        #enumerate essentially increments y, when y = 0
    ...
    def update(self, surface):
        ...
        if pygame.time.get_ticks() - self.update_time > animation_cooldown:
            ...
            if (self.frame_index >= len(self.animation_list[self.action])):
                #checks if player is dead, then end animation
                if self.alive == False:
                    ...
                    #check if an attack has been executed
